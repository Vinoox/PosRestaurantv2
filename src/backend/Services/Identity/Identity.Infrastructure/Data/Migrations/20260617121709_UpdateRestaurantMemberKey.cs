...
{
    /// <inheritdoc />
    public partial class UpdateRestaurantMemberKey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RestaurantRoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantMembers_RestaurantRoles_RestaurantRoleId",
                        column: x => x.RestaurantRoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantMembers_RestaurantId",
                table: "RestaurantMembers",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantMembers_RestaurantRoleId",
                table: "RestaurantMembers",
                column: "RestaurantRoleId");
